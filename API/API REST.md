...
**Summary**:API is the acronym for Application Programming Interface, which is a software intermediary that allows two applications/sytems to communicate to each other. A great testing tool to practice and learn API testing (requests and response) is the following [5].
