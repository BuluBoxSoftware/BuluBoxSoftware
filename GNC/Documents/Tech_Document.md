...
## Step 3
**DHL:** DHL will allow boxes over a pound in their endorsement Bulu will use DHL API to print the labels and manifest a schedule date for shipment.  Once DHL has the label manifested in the first forty-five minutes it will starts up until the forty-five days mark. The manifest will allow inquiry and questions about each customers shipment details. DHL and Bulu will both have tracking events all the way to the door customers door after manifest begins. Finally, one manifest copy will be given to the DHL driver and another to the final loaded pallet ready for shipment. 
